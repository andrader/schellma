...
class TestIndentation:
    ...
    def test_default_indentation(self):
        ...
        result = pydantic_to_typescript_type(SimpleModel)
    ...
    def test_custom_indentation_4_spaces(self):
        ...
        result = pydantic_to_typescript_type(SimpleModel, indent=4)
    ...
    def test_no_indentation(self):
        ...
        result = pydantic_to_typescript_type(SimpleModel, indent=False)
    ...
    def test_no_indentation_with_none(self):
        ...
        result = pydantic_to_typescript_type(SimpleModel, indent=None)
    ...
    def test_no_indentation_with_zero(self):
        ...
        result = pydantic_to_typescript_type(SimpleModel, indent=0)
    ...
    def test_json_schema_indentation(self):
        ...
        # Test with 3 spaces
        result = json_schema_to_typescript(schema, indent=3)
        assert '   "name": string,' in result
    ...
    def test_nested_objects_indentation(self):
        ...
        result = pydantic_to_typescript_type(User, define_types=True, indent=2)
    ...
    def test_compact_vs_indented_comparison(self):
        ...
        compact = pydantic_to_typescript_type(SimpleModel, indent=False)
        indented = pydantic_to_typescript_type(SimpleModel, indent=2)
    ...
    def test_invalid_indent_uses_default(self):
        ...
        result = pydantic_to_typescript_type(SimpleModel, indent=-1)
